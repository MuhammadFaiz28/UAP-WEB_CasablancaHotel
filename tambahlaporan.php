...
<section>
        <br>
        <h3 class="text-start ms-4 text-light fw-light">Laporan</h3>
        <br>
</section>
<section>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table cellspacing="2" cellpadding="4">
            <tbody>
                ...
                <tr>
                    <td>Tanggal</td>
                    <td>: <input type="date" name="tglupload" id="tanggal" required><br></td>
                </tr>
                <tr>
                    <td>Keterangan</td>
                    <td>: <input type="text" name="ket" id="ket" required><br></td>
                </tr>  
                <tr>
                    <td>Author</td>
                    <td>: <input type="text" name="author" id="author" required><br></td>
                </tr>
            </tbody>
        </table>
        <br>
        <button type="submit" name="submit" class="btn btn-outline-dark btn-lg"> Tambah data</button>
    </form>
    </p>
  </div>
</div>
