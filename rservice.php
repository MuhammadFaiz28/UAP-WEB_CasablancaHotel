...
if(isset($_POST["submit"])){
    mysqli_query($koneksi, "UPDATE customer SET layanan = '$layanan'");
    header( "refresh:0; url=rservice.php" );
}
...
<section data-bs-version="5.1" class="people5 mbr-embla cid-t6DVr0yL6t" id="people5-l">
    <div class="card ms-5 me-5">
        <h3 class="mbr-section-title mbr-fonts-style m-0 display-2 ms-2 mb-4"><strong>Room Service</strong></h3>
        <div class="card-header">
            Anda harus memesan kamar dan check-in terlebih dahulu.
        </div>
        <div class="card-body">
    ...
    <tbody>
        <tr>
            ...
            <td><?= $row["cout"]; ?></td>
            <td>
                <!-- <a  class="btn btn-dark" data-bs-toggle='modal' data-bs-target='#exampleModal'>Pesan Layanan</a>                 -->
                <?php
            ...
            <div class="modal-dialog">
              <div class="modal-content" >
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Apa layanan yang anda butuhkan?</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-footer">
                <form action="" method="POST">
                    <textarea id="layanan" name="layanan" rows="4" cols="50" required></textarea>                  
