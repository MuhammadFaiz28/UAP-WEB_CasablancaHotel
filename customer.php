...
<section>
    ...
    <tbody>
        <tr>
            ...
            <td><?= $row["rating"]; ?></td>
            <td>
                <a class='btn btn-dark' href="updatecustomer.php?id=<?= $row["id"]; ?>">update</a>
                <a class='btn btn-dark' href="hapuscustomer.php?id=<?= $row["id"]; ?>" onclick="return confirm('apakah anda yakin?');"
                >hapus</a>
            </td>
        </tr>
    </tbody>
